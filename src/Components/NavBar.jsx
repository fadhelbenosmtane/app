  ...
  return (
    ...
    <Navbar bg="white" expand="lg" fixed="top" >
      ...
      <Nav
            ...
            variant="tabs"
          >
            <Nav.Link href="#Accueil" className='mx-4'>Accueil </Nav.Link>
            <Nav.Link href="#Comparer" className='mx-4'>Comparer</Nav.Link>
            <Nav.Link href="#Qui-sommes-nous"className='mx-4'>Qui-sommes-nous</Nav.Link>
          </Nav>
          <Form className="d-flex ml-lg-2">
            <Form.Control
              type="search"
